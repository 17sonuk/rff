...
var queryChaincode = async function(peer, channelName, chaincodeName, args, fcn, username, org_name) {
	...
	try {
		...
		console.log("See here instance of Error in query.js")
		logger.debug(response_payloads[0] instanceof Error)
		...
		// 			' after the move');
		// 	}
		// 	return JSON.parse(response_payloads[0].toString('utf8'));
		// } else {
