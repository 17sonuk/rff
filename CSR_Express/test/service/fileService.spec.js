...
// describe('TESTING FILE SERVICE -  insertFile', () => {
//     before((done) => {
...
//             .catch((err) => done(err))
//     })
//     it('testing response for insertFile', async () => {
//         let file={
//             "fileName": "sample.pdf",
...
//             "fileSize": "3028",
//         }
//         let fileHash="4b41a3475132bd861b30a878e30aa56a"
//         // mockObj.resolves(file);
//         let res = await fileService.insertFile("add",file, fileHash)
//         expect(res.status).to.equal(200)

//         // //If communities is not getting saved
//         // mockObj.resolves(null);
//         // try {
//         //     let res = await fileService.insertFile(file, fileHash)
