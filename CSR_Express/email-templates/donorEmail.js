const { PLATFORM_NAME, PLATFORM_HASHTAG, FEEDBACK_EMAIL, CURRENCY, REGULATOR_NAME, TAX_ID } = require('./commonemailFields')

module.exports = {
    donorEmail: (firstName, amount, projectName, date, address) => {
        if (firstName === 'Guest') {
            return `<!DOCTYPE html>
            ...
            <p>We received your donation of <b>$${amount} ${CURRENCY}</b> on <b>${date}</b>.</p>
            
            <p>${REGULATOR_NAME}, administering contributions made to ${PLATFORM_NAME} is a 501(c)(3) non-profit organization with tax identification number ${TAX_ID}. Your gift is fully tax deductible; no goods and/or services were provided to you in exchange for this donation. Please keep this as a receipt of your donation.</p>
