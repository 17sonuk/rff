...
projectModelObj.getAllProjectsNgo = (ngoName) => {
    return projectModel.find({ ngo: ngoName }, { _id: 0, projectId: 1, place: 1, projectSummary: 1, description: 1, communities: 1, images: { $slice: 1 } }).then(data => {
        return data
    })
}
...
projectModelObj.getProjectsCorporate = (corporateName) => {
    return projectModel.find({ contributorsList: corporateName }, { _id: 0, projectId: 1, place: 1, communities: 1, projectSummary: 1, description: 1, images: { $slice: 1 } }).then(data => {
        return data
    })
}
...
projectModelObj.getAllProjects = () => {
    return projectModel.find({}, { _id: 0, projectId: 1, place: 1, projectSummary: 1, description: 1, communities: 1, images: { $slice: 1 } }).then(data => {
        return data
    })
}
